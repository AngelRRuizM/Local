<?php 
	...
	if ( !empty($_POST)) {		
		...
		if ($valid) {
			...
			$q->execute(array(addslashes($nombre_equipo),addslashes($nombre),addslashes($apellido),addslashes($nombre2),addslashes($apellido2),addslashes($nombre3),addslashes($apellido3)));
			Database::disconnect();
